        ...
        setContent {
            HealthLinkerTheme {
                Scaffold(modifier = Modifier.fillMaxSize()) { innerPadding ->
                    PatientHomeScreen(modifier = Modifier.padding(innerPadding))
                }
            }
        }
    }
...
@Composable
fun PatientHomeScreen(modifier: Modifier = Modifier) {
    ...
    Column(
        ...
        Text(text = "Welcome to Patient Home", fontSize = 24.sp)
